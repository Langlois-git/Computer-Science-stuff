...
run_docstring_examples(print_if, globals(), True)
...
run_docstring_examples(close_list, globals(), True)
...
"""Write a recursive function that takes in a positive integer n and determines if its digits contain two adjacent 8s. Do not use for or while."""
...
run_docstring_examples(make_onion, globals(), True)
